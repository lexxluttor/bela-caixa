...
function finalizarVenda(){
  ...
  try{
    ...
    // Mostra o comprovante primeiro para a finalizacao parecer imediata.
    setTimeout(function(){
      try{mostrarComp(vendaComp,cliComp,null);}catch(e){}
    },30);

    // Atualizacoes secundarias ficam para depois do comprovante.
    // A sincronizacao nao precisa ser forcada aqui: cada DB.set() ja chama
    // BelaSheetsSync.scheduleSync(), evitando trabalho duplicado na finalizacao.
    setTimeout(function(){
    ...
    setTimeout(function(){ _finalizandoVenda=false; }, 300);
  }
}
